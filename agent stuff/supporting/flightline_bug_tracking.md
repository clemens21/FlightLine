...
Use `defect` for player-created reports.
When a maintainer confirms the underlying problem as an engineering bug, add `bug` and the normal severity and `area:*` labels.
