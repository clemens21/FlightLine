...
try {
  ...
  assert.equal(zeroHireDetailHtml.includes("Pilot snapshot"), true);
  assert.equal(zeroHireDetailHtml.includes("Strengths and weaknesses"), true);
  assert.equal(zeroHireDetailHtml.includes("Pricing summary"), false);
  assert.equal(zeroHireDetailHtml.includes("Choose hire path"), false);
