...
try {
  ...
  assert.match(shellHtml, /\.contracts-board-wrap thead\s*\{/);
  assert.match(shellHtml, /\.aircraft-table-wrap thead\s*\{/);
  ...
  assert.equal(staffingTab.contentHtml.includes('data-staffing-hire-column="stress"'), true);
  assert.equal(staffingTab.contentHtml.includes('data-staffing-hire-column="procedure"'), true);
  assert.equal(staffingTab.contentHtml.includes('data-staffing-hire-column="training"'), true);
  ...
  assert.equal(staffingTab.contentHtml.includes('data-staffing-hire-column="direct_hire"'), true);
