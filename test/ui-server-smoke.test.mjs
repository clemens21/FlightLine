...
try {
  ...
  assert.equal(staffingTab.contentHtml.includes("<th>Base</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Certification(s)</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Total hours</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Reliability</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Stress</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Procedure</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Training</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Lane hours</th>"), false);
  assert.equal(staffingTab.contentHtml.includes("<th>Starting price</th>"), false);
  assert.equal(staffingTab.contentHtml.includes("<th>Direct hire</th>"), true);
  assert.equal(staffingTab.contentHtml.includes("<th>Contract hire</th>"), true);
  ...
  assert.equal(staffingTab.contentHtml.includes('data-pilot-stat-rating="trainingAptitude"'), true);
  ...
  assert.equal(hireDetailHtml.includes("Pilot snapshot"), true);
  assert.equal(hireDetailHtml.includes("Direct versus contract"), true);
  assert.equal(hireDetailHtml.includes("Strengths and weaknesses"), true);
  assert.equal(hireDetailHtml.includes("Pricing summary"), false);
  assert.equal(hireDetailHtml.includes("Choose hire path"), false);
  assert.equal(hireDetailHtml.includes("Qualification lane"), false);
  assert.equal(hireDetailHtml.includes("Total career hours"), true);
  assert.equal(hireDetailHtml.includes("Certification hours"), true);
  assert.equal(hireDetailHtml.includes("SEPL"), true);
  assert.equal(hireDetailHtml.includes("SEPS"), true);
  assert.equal(hireDetailHtml.includes("MEPL"), true);
  assert.equal(hireDetailHtml.includes("MEPS"), true);
  assert.equal(hireDetailHtml.includes("JET"), true);
  assert.equal(hireDetailHtml.includes("JUMBO"), true);
  assert.equal(hireDetailHtml.includes("0h"), true);
  assert.equal(hireDetailHtml.includes("Operational reliability"), true);
  assert.equal(hireDetailHtml.includes("/10"), true);
  assert.equal(hireDetailHtml.includes("which means this pilot should"), true);
  assert.equal(hireDetailHtml.includes("Both hire paths use visible lane complexity"), false);
  assert.equal((hireDetailHtml.match(/data-pilot-candidate-hire=/g) ?? []).length, 2);
